...
*/
namespace Tall\Migration\Formatters;

use Illuminate\Support\Str;
use Tall\Migration\Helpers\Formatter;
...
class TableFormatter
{
    ...
    public function getStubPath(): string
    {
        ...
        if (file_exists($overridden = resource_path('stubs/vendor/tall-migration/' . $driver . '-table.stub'))) {
            return $overridden;
        }

        if (file_exists($overridden = resource_path('stubs/vendor/tall-migration/table.stub'))) {
            return $overridden;
        }
    ...
    public function getStubCreatePath(): string
    {
        ...
        if (file_exists($overridden = resource_path('stubs/vendor/tall-migration/' . $driver . '-table-create.stub'))) {
            return $overridden;
        }

        if (file_exists($overridden = resource_path('stubs/vendor/tall-migration/table-create.stub'))) {
            return $overridden;
        }
    ...
    public function getStubModifyPath(): string
    {
        ...
        if (file_exists($overridden = resource_path('stubs/vendor/tall-migration/' . $driver . '-table-modify.stub'))) {
            return $overridden;
        }

        if (file_exists($overridden = resource_path('stubs/vendor/tall-migration/table-modify.stub'))) {
            return $overridden;
        }
    ...
    public function stubNameVariables($index): array
    {
        ...
        return [
            ...
            'IndexedTimestamp'      => app('tall-migration:time')->clone()->addSeconds($index)->format('Y_m_d_His')
        ];
    }
