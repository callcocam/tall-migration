...
*/
namespace Tall\Migration\Commands;
...
use Tall\Migration\GeneratorManagers\MySQLGeneratorManager;
...
class GenerateMigrationsCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->option('empty-path') || config('tall-migration.clear_output_path')) {
